        ...
        <div class="card blue-grey darken-1">
          <div class="card-content white-text">
            <?php
              ...
              $query = "SELECT * FROM purchases a, products b WHERE (a.customerID = b.customerId) AND productId IN (SELECT purchases.productId FROM purchases, customers WHERE purchases.customerId = customers.customerId AND ";
